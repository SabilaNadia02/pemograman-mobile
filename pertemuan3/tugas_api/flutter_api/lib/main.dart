...
String url_domain = "http://192.168.77.222:8000/";
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Table(
                ...
                columnWidths: {0: FlexColumnWidth(1.5), 1: FlexColumnWidth(2), 2: FlexColumnWidth(5)},
                children: [
                  TableRow(children: [
                    Text(
                      'Nama',
                  ...
                  for (var data in all_data)
                    TableRow(children: [
                      ...
                      Container(
                        ...
                        child: Table(
                          border: TableBorder(
                              horizontalInside: BorderSide(width: 0, color: Colors.blue, style: BorderStyle.solid)),
                          children: [
                            TableRow(children: [
                              MaterialButton(
                                color: Colors.blue,
      ...
      child: Column(
        children: [
          ...
          MaterialButton(
            ...
            onPressed: () {
              print("object");
              if (nameController.text == "" || bankController.text == "" || alamatController.text == "") {
                print("zero");
              } else {
          ...
          MaterialButton(
            ...
            onPressed: () {
              ...
              if (idController_update.text == "" ||
                ...
                update_data(idController_update.text, nameController_update.text, bankController_update.text,
                    alamatController_update.text);
                Navigator.of(context).pop();
              }
            },
